      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">UPLOADED POSTS</a>
          </div>
    ...
    <div class="container row-fluid">
        ...
        <thead class="thead-dark row-fluid ">
          <tr>
              ...
              <th class='span6' scope="col">Date Modified</th>
              <th class='span6' scope="col">Created By</th>
              <th class='span4' scope="col">Edit My Post</th>
          </tr>
        </thead>
          <tbody>
          <tr>
            ...
            <a class="btn btn-link pull-right" data-toggle="modal" data-target="#Details">Details ></a>
              ...
              <td>Ram</td>
              <td>
                <a class="btn btn-link" data-toggle="modal" data-target="#reply"><i class="fa fa-pencil"></i> Edit</a>
              </td>
          </tr>
           <!-- The Modal -->
                <div class="modal" id="reply">
                  <div class="modal-dialog">
                   ...
                   <!-- Modal footer -->
                <div class="modal-footer">
                 <button type="button pull-righe" class="btn btn-success" data-dismiss="modal">Send</button>
                </div>

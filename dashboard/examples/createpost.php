...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Create Query</a>
          </div>
 ...
 <div class="container">
  <form action="javascript:add_query()">
    <div class="form-group">
      <label for="QUERY"> QUERY:</label>
      <input type="TEXT" class="form-control" id="post_title" placeholder="Enter The Query" name="Query">
    </div>
    <div class="form-group">
      <label for="to">SUB QUERY:</label>
      <input type="text" class="form-control" id="sub_post" placeholder="Enter Category" name="Category">
    </div>
     <div class="form-group">
      <label for="assigned_to">ASSIGNED TO:</label>

       <div class="form-check row">
        <label class="form-check-label row"><input type="radio" value="All" id="assigned_to" class="btn" name="optradio">All</label>
        <?php foreach ($get_users as $key => $value) { ?>
        <?php foreach ($value as $k => $v) {?>  
          <label class="form-check-label row"><input type="radio" value="<?= $v->email;?>" id='assigned_to' class="btn" name="optradio"><?= $v->email;?></label>
...
function add_query(){
  ...
  var sub_post = document.getElementById('sub_post').value;
  alert(assigned_to);
  var arr = {
    ...
    axios.post('http://localhost/virtusa/login/functions/products/insert_post.php', arr, config)
      .then((response) => {
      ...
      if (response.data === 'product created.') {
        ...
        window.location = "./createpost.php?user="+'<?php echo $user ?>';
        });
      }
